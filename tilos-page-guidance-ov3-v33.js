...
function special(){const f=A.flow;if(f?.kind==='ov3'){
 const map={
  learner:g('Choose the learner','Search for and select the learner you are assessing. Andros will use the course attached to that learner for the rest of the observation.','Choose the learner whose work you are physically observing today.'),
  ...
  report:g('Observation report','Check the report Andros has drafted from the practical areas, photographs, videos and recorded discussion. Keep it factual and no more than 100 words, then choose Competent or Needs more training.','The learner set out and built the wall to line and level, with photographs showing the work at key stages. The recorded discussion confirmed their understanding of the relevant cavity components.'),
